...
| `303 See Other`          | The client should `GET` the URL found in the `Location` header. | [Action](profiles/action.md)                                 | RFC 7231, [section 6.4.4](https://tools.ietf.org/html/rfc7231#section-6.4.4) |
...
| `409 Conflict`             | Resource state conflict. Used in PATCH responses when the content cannot be patched successfully given the supplied patch body. | [Data](profiles/data.md)                                     | RFC 7231, [section 6.5.8](https://tools.ietf.org/html/rfc7231#section-6.5.8) |
